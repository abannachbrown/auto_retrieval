...
## produce the plots
plot(year, papers, type='b', main="Increase in Human Systematic Reviews - Count per year 2008:2018", xlab = "Year",ylab="Articles")
```
...
## produce the plots
plot(year, papers_animal, type='b', main="Increase in Animal Systematic Reviews - Count per year 2008:2018", xlab = "Year",ylab="Articles")
```
