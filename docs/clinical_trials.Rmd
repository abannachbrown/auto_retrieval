...
This is document which shows the summary information about trials registered in <a href="http://clinicaltrials.gov" target="_blank" ClinicalTrials.gov </a>. 
...
Graph showing the increase in clinical intervention trials published in the last
```{r over time}
...
with(ctOverTime, plot(numOfTrials ~ startDate, type = "l",main="Number of Intervention Trials 2009-2019", xlab = "Time",ylab="Trials"))
