...
```{r}
#### code taken from Billy Caughey tutorial ##
#### 9th March 2017 https://rpubs.com/wgcaughey1984/257099 ##
...
with(ctOverTime, plot(numOfTrials ~ startDate, type = "l",main="Number of Trials Registered Over Time",
